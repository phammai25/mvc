            ...
            <div class="container-fluid">
                ...
                <div style="float: right;" class="dropdown"><a href=""><img src="public/img/login.png" style="width: 40px"></a>
                    <div class="dropdown-content">
                        <table >
                            <tr><td><a href="http://localhost/TT%20PHP/MVC_POST/index.php?url=login/check">Đăng Nhập</a></td></tr>
                            <tr><td><a href="http://localhost/TT%20PHP/MVC_POST/index.php?url=register/postDangKi">Đăng kí</a></td></tr>
                        </table>
                    </div>
                </div>
            </div>
